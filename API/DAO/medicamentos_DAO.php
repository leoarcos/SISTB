...
class medicamentos_DAO {
    ...
    public function listarMedicamentosExistentes() {
        ...
        $sql = "select * from farmacia where cantidad!='0' and cantidad>0 order by nombre,to_date(fechavencimiento, 'DD MM YYYY') asc";
    ...
    public function listarMedicamentosPendientes(){
        ...
        $sql = "select * from medicamentocomprometido where numeroidentificacion like '%%' order by nombremedicamento,to_date(fechavencimiento, 'DD MM YYYY'),consecutivoautorizacion asc";
    ...
    public function listarMedicamentosPendientesFechas($fechaInicio, $fechaFin){
        ...
        $sql = "SELECT * FROM medicamentocomprometido WHERE CONSECUTIVOAUTORIZACION IN (select CONSECUTIVOAUTORIZACION from autorizacion where to_date(fechasolicitud, 'DD MM YYYY') between to_date('".$fechaInicio."', 'DD MM YYYY') and to_date('".$fechaFin."', 'DD MM YYYY'))";
